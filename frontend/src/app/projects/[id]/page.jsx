  ...
  return (
    <main className="ocean-page">
      ...
      <div className="ocean-container max-w-4xl">
        ...
        {project && (
          <div className="detail-ocean-card relative mx-auto w-full max-w-205 pb-16 text-[#173a54]">
            ...
            <p className="mt-5 rounded-2xl border-2 border-[#0f5f92] bg-[#fff7d4] px-4 py-4 text-xl font-bold text-[#2f5f7e]">
              {project.description || 'No description'}
            </p>

            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              <div className="wood-item h-auto flex-col items-start gap-1 py-4">
                <p className="text-sm font-black uppercase tracking-wide text-[#0d3f63]">Status</p>
                <p className="text-2xl font-black text-[#153852]">{project.status}</p>
              </div>
              <div className="wood-item h-auto flex-col items-start gap-1 py-4">
                <p className="text-sm font-black uppercase tracking-wide text-[#0d3f63]">Priority</p>
                <p className="text-2xl font-black text-[#153852]">{project.priority}</p>
              </div>
            </div>

            <Link
              className="detail-requirements-corner"
